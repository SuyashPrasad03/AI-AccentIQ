...
async def _get_owned_recording(
    ...
    # Owner check — relaxed for cross-domain deployment
    # Only enforce if we can positively identify the user AND they don't match
    if identity.is_authenticated and recording.user_id:
